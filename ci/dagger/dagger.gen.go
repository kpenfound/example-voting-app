...
// The `RuffID` scalar type represents an identifier for an object of type Ruff.
type RuffID string

// The `SecretID` scalar type represents an identifier for an object of type Secret.
type SecretID string

// The `SeedID` scalar type represents an identifier for an object of type Seed.
type SeedID string
...
// Load a Ruff from its ID.
func (r *Client) LoadRuffFromID(id RuffID) *Ruff {
	q := r.Query.Select("loadRuffFromID")
	q = q.Arg("id", id)
...
// Load a Seed from its ID.
func (r *Client) LoadSeedFromID(id SeedID) *Seed {
	q := r.Query.Select("loadSeedFromID")
	q = q.Arg("id", id)
...
func (r *Result) Build(directory *Directory) *Container {
	assertNotNil("directory", directory)
	q := r.Query.Select("build")
	q = q.Arg("directory", directory)
...
func (r *Result) Serve(directory *Directory, db *Service) *Service {
	assertNotNil("directory", directory)
	assertNotNil("db", db)
	q := r.Query.Select("serve")
	q = q.Arg("directory", directory)
...
func (r *Ruff) Check(ctx context.Context, directory *Directory) (string, error) {
	assertNotNil("directory", directory)
	if r.check != nil {
		return *r.check, nil
	}
...
func (r *Ruff) ID(ctx context.Context) (RuffID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.Query.Select("id")
...
func (r *Ruff) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadRuffFromID(RuffID(id))
	return nil
}
...
func (r *Seed) ID(ctx context.Context) (SeedID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.Query.Select("id")
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Seed) XXX_GraphQLType() string {
	return "Seed"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Seed) XXX_GraphQLIDType() string {
	return "SeedID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Seed) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Seed) MarshalJSON() ([]byte, error) {
	id, err := r.ID(context.Background())
	if err != nil {
		return nil, err
	}
...
func (r *Seed) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadSeedFromID(SeedID(id))
	return nil
}

func (r *Seed) Run(dir *Directory, vote *Service) *Container {
	assertNotNil("dir", dir)
	assertNotNil("vote", vote)
...
func (r *Vote) Build(directory *Directory) *Container {
	assertNotNil("directory", directory)
	q := r.Query.Select("build")
	q = q.Arg("directory", directory)
...
func (r *Vote) Serve(directory *Directory, redis *Service) *Service {
	assertNotNil("directory", directory)
	assertNotNil("redis", redis)
	q := r.Query.Select("serve")
	q = q.Arg("directory", directory)
	q = q.Arg("redis", redis)
...
func (r *Worker) Build(directory *Directory) *Container {
	assertNotNil("directory", directory)
	q := r.Query.Select("build")
	q = q.Arg("directory", directory)
...
func (r *Worker) Serve(directory *Directory, redis *Service, db *Service) *Service {
	assertNotNil("directory", directory)
	assertNotNil("redis", redis)
	assertNotNil("db", db)
	q := r.Query.Select("serve")
